...
parser.add_argument('--dataset_name', type=str, default='DaGuang',
...
parser.add_argument('--embedding_dim', type=int, default=500, help='random init char embedding_dim')
...
train_file='dg_train_t_8.txt'
test_file='dg_train_v_8.txt'
args.mode='train'
args.demo_model='1570174461'
args.CRF=True
args.hidden_dim=512
